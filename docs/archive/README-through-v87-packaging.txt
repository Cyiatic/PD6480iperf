Historical snapshot: README as read before the September 15, 2026 documentation cleanup.
Its current/final/pending claims and relative paths describe earlier states, not current guidance.
See ../../README.md and ../HISTORY.md for the current release and chronology.
